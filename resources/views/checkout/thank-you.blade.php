...
<html lang="{{ app()->getLocale() }}">
  ...
  <body>
    ...
    <main class="main container-fluid mt-3 mb-5" style="width: 95%">
      <div class="thankYouContainer text-center">
        <span class="thankYouMessageSpan">Thank you for shopping with us!</span> <br />
        Your order ID is <span class="thankYouOrderIdSpan">ECW-{{ $order -> id }}</span><br />
        <small>Please note the order ID for for future reference.</small>
      </div>
